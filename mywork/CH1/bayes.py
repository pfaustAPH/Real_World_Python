...
class Search():
    ...
    def sailor_final_location(self, num_search_areas):
        """return the actual x,y location fo the missing sailor."""
        # Find sailor coordinates with respect to any Search Area subarray
        self.sailor_actual[0] = np.random.choice(self.sal.shape[1], 1)
        self.sailor_actual[1] = np.random.choice(self.sal.shape[0], 1)
